...
public class WXPayUtil {
	...
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(WXPayUtil.class);
	...
	public static Map<String, String> xmlToMap(String strXML) throws Exception {
		try {
			...
			org.w3c.dom.Document doc = getDocumentBuilder().parse(stream);
	...
	/**
	 * @Description: json转map @param @param json @param @return 设定文件 @return
...
//			logger.info("A DOCTYPE was passed into the XML document");
//		} catch (IOException e) {
