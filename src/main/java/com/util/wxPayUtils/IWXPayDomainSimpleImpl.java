 ...
 * @date: 2017-12-21 下午2:02:37
 */
public class IWXPayDomainSimpleImpl implements IWXPayDomain {

	private IWXPayDomainSimpleImpl() {
	}

	private static class WxpayDomainHolder {
		private static IWXPayDomain holder = new IWXPayDomainSimpleImpl();
	}
