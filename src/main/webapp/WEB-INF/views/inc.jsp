...
<script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/jslib/ueditor1_4_3_3-utf8-jsp/lang/zh-cn/zh-cn.js"></script>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/jslib/jquery-validation-1.14.0/lib/jquerySession.js" charset="utf-8"></script>
