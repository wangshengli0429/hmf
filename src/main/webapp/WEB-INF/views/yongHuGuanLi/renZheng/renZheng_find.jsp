			...
			<table align="center" style="border-collapse:separate; border-spacing:0px 10px;">
				...
				<tr>
					...
					<td>
					    ...
					    <!-- 资料图片 -->
					    <c:if test="${not empty l.certUrl && l.certUrl!=''}">
						<div style="display:inline;">
						...
						<c:if test="${not empty l.card1 && l.card1!=''}">
						...
						<c:if test="${not empty l.card2 && l.card2!=''}">
						<div style="display:inline;padding-left:5px;">
						...
						<c:if test="${empty l.certUrl || l.certUrl==''}">
							<c:if test="${empty l.card1 || l.card1==''}">
								<c:if test="${empty l.card2 || l.card2==''}">
									未上传
								</c:if>
							</c:if>
							</c:if>
				...
				<tr>
					...
					<td>
						...
						<c:if test="${empty l.title || l.title==''}">
							未上传
						</c:if>
						<br>
					</td>
	...
	$(function(){
 		$("#radio1").click(function(){
  		...
  		$("#radio2").click(function(){
  			var v1 = $('input:radio[name="ziLiao"]:checked').val();
  			var v2 = $('input:radio[name="zuoWen"]:checked').val();
   			if (v1 == 1 && v2 == 1){
   				$("#td1").hide();
   			}
  		});
