...
<c:forEach items="${wdp}" var="w">
	...
	<!-- // 查看图片 // -->
    <a name='fff' href='javascript:void(0);' onclick='picBig1()'><img id="i1" src="${w.img1}" style="width:100px;{${w.img1}==null?'display: none;':''}"></a>
    <a name='fff' href='javascript:void(0);' onclick='picBig2()'><img id="i2" src="${w.img2}" style="width:100px;{${w.img2}==null?'display: none;':''}"></a>
    <a name='fff' href='javascript:void(0);' onclick='picBig3()'><img id="i3" src="${w.img3}" style="width:100px;{${w.img3}==null?'display: none;':''}"></a>
	<!-- // 查看图片 // -->
	<div id="divCenter1" align="center" style="position: absolute; z-index: 9999; display: none;left:200px;">
        <div style="display:inline;margin-right:150px; width：320px;" onclick="shang1()">
        	<a><img src="<%=request.getContextPath()%>/images/fanhui.png" width="20px" title="上一个"/></a>
        </div>
        <div style="display:inline;" onclick="picClose()">
        	<img src="${w.img1}" width=700px/>
        </div>
        <div style="display:inline;margin-left:150px; width：320px;" onclick="xia1()">
        	<a><img src="<%=request.getContextPath()%>/images/qianjin.png" width="20px" title="下一个"/></a>
        </div>
    </div>
    <div id="divCenter2" align="center" style="position: absolute; z-index:9999; display: none;left:200px;">
        <div style="display:inline;margin-right:150px; width：320px;" onclick="shang2()">
        	<a><img src="<%=request.getContextPath()%>/images/fanhui.png" width="20px" title="上一个"/></a>
        </div>
        <div style="display:inline;" onclick="picClose()">
        	<img src="${w.img2}" width=700px/>
        </div>
        <div style="display:inline;margin-left:150px; width：320px;" onclick="xia2()">
        	<a><img src="<%=request.getContextPath()%>/images/qianjin.png" width="20px" title="下一个"/></a>
        </div>
    </div>
    <div id="divCenter3" align="center" style="position: absolute; z-index: 9999; display: none;left:200px;">
        <div style="display:inline;margin-right:150px; width：320px;" onclick="shang3()">
        	<a><img src="<%=request.getContextPath()%>/images/fanhui.png" width="20px" title="上一个"/></a>
        </div>
        <div style="display:inline;" onclick="picClose()">
        	<img src="${w.img3}" width=700px/>
        </div>
        <div style="display:inline;margin-left:150px; width：320px;" onclick="xia3()">
        	<a><img src="<%=request.getContextPath()%>/images/qianjin.png" width="20px" title="下一个"/></a>
        </div>
    </div>
...
<script>
	...
	<%-- location.href="<%=request.getContextPath()%>/teacherPC/yuPiGai/yuPiGai_tiJiao.jsp"; --%>
</script>
