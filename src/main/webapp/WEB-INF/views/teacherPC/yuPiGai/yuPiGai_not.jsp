...
<hr>
<form id="updateForm" action="<%=request.getContextPath()%>/servlet/TeacherFindServlet?do=9" method="post">
<div style="padding-left:200px;padding-right:200px;">
	<p><b>审核<span style="color:red">未通过</span>，请重新点评作文，提交审核</b></p>
	...
	<input type="hidden" name="id" id="ydpId" value="${y.id}">
	<input type="hidden" name="grade" id="ydpGrade" value="${y.grade}">
	<br><br>
	
	<div style="margin-top:10px;">
	<img src="<%=request.getContextPath()%>/images/1.png" alt="alttext" title="名师点评" style="float:left;width:100%;">
	</div>
	<div style="margin-top:20px;">
		<span style="font-size:17px;margin-left:0px;margin-top:20px;">打分：</span>
		<input type="number" name="score" id="score" value="${y.score}" class="form-control" style="width:178px;height:35px;display:inline;" placeholder="请输入作文分值">
		<span id="spanId" style="display:inline;"></span>
	</div>
	
	<!-- 评分标准 -->
	<input type="hidden" name="pcontent" id="pcontent" value="${y.dpcontent}">
	<input type="hidden" name="planguage" id="planguage" value="${y.dplanguage}">
	<input type="hidden" name="pstructure" id="pstructure" value="${y.dpstructure}">
	<input type="hidden" name="pwriting" id="pwriting" value="${y.dpwriting}">
	...
	<img src="<%=request.getContextPath()%>/images/2.png" alt="alttext" title="评点教育" style="float:left;width:1150px;">
	</div>
	...
	<div style="margin-top:20px;margin-left:0px;border-collapse:separate; border-spacing:0px 20px; background-color:#c9c9c9;">
		...
		<div style="margin-left:10px;margin-right:10px;margin-top:0px;background-color:#ffffff;height:200px;">
			<textarea name="scoring" id="editor1" onchange="validateString1(this.value)" style="width:100%;height:100%;background-color: #ffffff; border: 1px #D7D7D7 solid;font-size: 16px;">${y.scoring}</textarea>
		</div>
		...
		<div style="margin-left:10px;margin-right:10px;margin-top:0px;background-color:#ffffff;height:200px;">
			<textarea name="points" id="editor2" onchange="validateString2(this.value)" style="width:100%;height:100%;background-color: #ffffff; border: 1px #D7D7D7 solid;font-size: 16px;">${y.points}</textarea>
		</div>
		<div style="margin-left:10px;margin-right:10px;margin-top:0px;background-color:#ffffff;">
		...
		<div style="margin-left:10px;margin-right:10px;margin-top:0px;background-color:#ffffff;height:200px;">
			<textarea name="suggest" id="editor3" onchange="validateString3(this.value)" style="width:100%;height:100%;background-color: #ffffff; border: 1px #D7D7D7 solid;font-size: 16px;">${y.suggest}</textarea>
		</div>
		<div style="margin-left:10px;margin-right:10px;margin-top:0px;background-color:#ffffff;">
