...
<div class="viewFramework-content">
	...
	<div class="inline-block" style="text-align:center;padding-top:28px;">
		<b>
			<span style="color:#54ae7b;font-family:Microsoft YaHei;font-size:40px;">作文提交</span>
		</b>
	</div>
	<div style="text-align:center;padding-top:60px;">
		<b>
			<span id="cause1" style="color:#333333;font-family:Microsoft YaHei;font-size:20px;">您的预点评作文已提交，我们将尽快为您处理，请等候！</span><br>
