...
<table class="table table-hover" style="width: 100%;">
	...
	<tr>
		...
		<td name="one" style="text-align: center"><a href="##" onclick="selectJifa(${l.id})">${l.name}</a></td>
...
function quXiao(){
	...
	function addQita(){
		var d = dialog({
			...
			ok: function () {
				...
				location.href="<%=request.getContextPath()%>/servlet/ManageZuowenServlet?do=29&id="+selectvalue;
			},
			cancelValue: '取消',
			cancel: function () {}
		});
	...
	function selectJifa(id){
		$.ajax({
			url:"<%=request.getContextPath()%>/servlet/ManageZuowenServlet?do=27&id="+id,
			type:"post",
			dataType: "json",
