...
<table class="table table-hover" style="width: 100%;">
	...
	<tr>
		<td style="text-align: center;width:10px">
			<input type="radio" name="radio" value="${l.id}">
			<textarea id="editor" name="content" type="text/plain" style="display:none;width:800px;height:300px;">${l.content}</textarea>
