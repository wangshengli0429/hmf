...
<form id="userId" action="<%=request.getContextPath()%>/servlet/CardManageServlet?do=1" method="post" class="form-inline" role="form">
	<div style="display:inline;float: right;">
	  <input type="text" name="name" id="name" value="${name}" class="form-control" style="width:178px;height:19px;" placeholder="用户名/昵称/用户名称" >
...
<tbody>
	...
	<tr align="center">
		<td><input type="checkbox" name="stuid" value="${l.id}"></td>
		<td name="">${l.phone}</td>
