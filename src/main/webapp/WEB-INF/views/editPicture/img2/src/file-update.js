...
window.onload = function(){
	...
	if(img_width>700){
		...
		document.getElementById("mycanvas").style.maxWidth = img_width + "px";
		document.getElementById("mycanvas").style.maxHeight = img_height + "px";
	}
