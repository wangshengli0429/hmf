...
var $canvas_area2 = $(E("div")).addClass("canvas-area2").appendTo($canvas_area);
//var $canvas_com = $(E("div")).addClass("canvas-com").appendTo($H);
//var $canvas2 = $(canvas).appendTo($canvas_area);
//$canvas2.attr("id","mycanvas2");
