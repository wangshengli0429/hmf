...
<form id="scform" action="<%=request.getContextPath()%>/servlet/ManageFindFwServlet?do=10" method="post" class="form-inline" role="form">
<table align="center" style="border-collapse:separate; border-spacing:0px 10px;">
	<tr>
		<td align="right">素材标题：</td>
		<td><input type="text" name="scTitle" id="scTitle" class="form-control" style="width:178px;height:19px;" placeholder="请输入素材标题"></td>
	</tr>
	<tr>
		<td>年级：</td>
	    <td>
	    <select name="scGrade" id="scGrade" class="form-control" style="width:205px;">
	      	...
	      	<option value="${a.CODE}">${a.CODE_NAME}</option>
	      	</c:forEach>
	    </select>
	    </td>
	</tr>
	...
	<tr>
		...
		<td>
			<div>
		    <textarea id="editor" name="content" type="text/plain" style="width:800px;height:300px;" required><span style="color:#d6d6d6;">请输入素材内容，字数为1-2000字之间。</span></textarea>
			</div>
		</td>
	</tr>
	<tr>
		...
		<td> &nbsp;&nbsp;&nbsp;&nbsp;
			<button type="button" onclick="quXiao()" class="btn btn-default" data-toggle="button" style="width:90px;">取&nbsp;消</button>
			 &nbsp;&nbsp;&nbsp;&nbsp;
			<button type="submit" onclick="return addSuCai()" class="btn btn-default" data-toggle="button" style="width:90px;">确&nbsp;定</button>
		</td>
	</tr>
</table>
</form>
