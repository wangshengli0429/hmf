...
<form id="jfform" action="<%=request.getContextPath()%>/servlet/ManageFindFwServlet?do=17" method="post" class="form-inline" role="form">
<table align="center" style="border-collapse:separate; border-spacing:0px 10px;">
	<tr>
		<td align="right">技法标题：</td>
		<td><input type="text" name="jfTitle" id="jfTitle" class="form-control" style="width:178px;height:19px;" placeholder="请输入范文标题"></td>
	</tr>
	<tr>
		<td>年级：</td>
	    <td>
	...
	<tr>
		...
		<td> &nbsp;&nbsp;&nbsp;&nbsp;
			<button type="button" onclick="quXiao()" class="btn btn-default" data-toggle="button" style="width:90px;">取&nbsp;消</button>
			 &nbsp;&nbsp;&nbsp;&nbsp;
			<button type="submit" onclick="return addJiFa()" class="btn btn-default" data-toggle="button" style="width:90px;">确&nbsp;定</button>
		</td>
	</tr>
</table>
</form>
