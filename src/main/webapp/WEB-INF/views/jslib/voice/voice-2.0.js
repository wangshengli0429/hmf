        ...
        */
        RongIMVoice.init = function () {
            if (this.isIE) {
                ...
                script.src = "<%=request.getContextPath()%>/jslib/voice/swfobject.js";
                ...
                setTimeout(function () {
                    ...
                    swfobject.embedSWF("./player.swf", "flashContent", "1", "1", swfVersionStr, null, flashvars, params, attributes);
                }, 200);
            }
            else {
            	/*document.write("<script type='text/javascript' src='./pcmdata.min.js'></script>");  
            	document.write("<script type='text/javascript' src='./libamr-min.js'></script>");  */
               /* var list = ["pcmdata.min.js", "libamr-min.js"];
